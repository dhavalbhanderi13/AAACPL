...
public class LotsService {
    ...
    public Response createLot(CreateLotRequest createLotRequest) {
        CreateLotRequestBO createLotRequestBO = new CreateLotRequestBO(createLotRequest.getAuctionId(), createLotRequest.getName(),
                createLotRequest.getDescription(), createLotRequest.getStartBid(), createLotRequest.getDifferenceFactor(),
                createLotRequest.getStartDate(), createLotRequest.getEndDate(), createLotRequest.getCreatedBy(), createLotRequest.getUpdatedBy());
    ...
    public Response getAllLots(@PathParam("auctionId") int auctionId) {
        ...
        lotsListResponse.setLotsResponseList(lotsRequestHandler.getAllLots(auctionId));
    ...
    public Response getLotsByUserAccess(@PathParam("userId") int userId, @PathParam("auctionId") int auctionId) {
        ...
        lotsListResponse.setLotsResponseList(lotsRequestHandler.getLotsByAccess(userId, auctionId));
        return ResponseGenerator.generateResponse(lotsListResponse);
    }
    ...
    public Response insertBid(BidRequest bidRequest) {
        BidRequestBO bidRequestBO = new BidRequestBO(bidRequest.getLotId(), bidRequest.getUserId(), bidRequest.getBidAmount(),
    ...
    public Response getStatus(StatusRequest statusRequest) {
        ...
        LotsRequestHandler lotsRequestHandler = new LotsRequestHandler();
        LotStatusResponse lotStatusresponse = lotsRequestHandler.getLotStatus(statusRequest);
