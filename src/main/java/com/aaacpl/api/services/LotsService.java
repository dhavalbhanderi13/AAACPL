...
public class LotsService {
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response updateLot(UpdateLotRequest updatecreateLotRequest) {
	...
	public Response getLotsByUserAccess(@PathParam("userId") int userId,
			@PathParam("auctionId") int auctionId) {
		LotsRequestHandler lotsRequestHandler = new LotsRequestHandler();
	...
	@Produces(MediaType.APPLICATION_JSON)
	public Response getBidHistory(@PathParam("lotId") int lotId) {
