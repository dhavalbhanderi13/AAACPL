 ...
 */
public class LotsByAccessResponse {
    ...
    public LotsByAccessResponse(int id, int auctionId, String name, String description, String startBid, int differenceFactor, String startDate, String endDate, int createdBy, int updatedBy) {
        this.id = id;
